...
Следует отметить, что порт 50000 используется для связи между Jenkins мастером и агентами. Для сохранения данных Jenkins необходимо использовать том, монтируемый в `/var/jenkins_home`.
